...
<body>
    ...
    <div id="container-2">
            <form action="./curso2.php" method="POST" id="formulario-escolha">
                ...
                <div>
                    <input type="radio" name="opcao" id="criar" value="1"><label for="criar"> Criar curso</label><br><br>

                    <input type="radio" name="opcao" id="pesquisar" value="2"><label for="pesquisar"> Pesquisar curso</label><br><br>

                    <input type="radio" name="opcao" id="listar" value="3"><label for="listar"> Mostrar cursos</label><br><br>

                    <input type="radio" name="opcao" id="alterar" value="4"><label for="alterar"> Alterar curso</label><br><br>

                    <input type="radio" name="opcao" id="excluir" value="5"><label for="excluir"> Excluir curso</label>
                </div><br>
