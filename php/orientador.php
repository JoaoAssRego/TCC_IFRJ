...
<body>
    ...
    <div id="container-2">
            <form action="./orientador2.php" method="POST" id="formulario-escolha">
                ...
                <div>
                    <input type="radio" name="opcao" id="criar" value="1"><label for="criar"> Criar orientador</label><br><br>

                    <input type="radio" name="opcao" id="pesquisar" value="2"><label for="pesquisar"> Pesquisar orientador</label><br><br>

                    <input type="radio" name="opcao" id="listar" value="3"><label for="listar"> Mostrar orientadores</label><br><br>

                    <input type="radio" name="opcao" id="alterar" value="4"><label for="alterar"> Alterar orientador</label><br><br>

                    <input type="radio" name="opcao" id="excluir" value="5"><label for="excluir"> Excluir orientador</label>
                </div><br>
