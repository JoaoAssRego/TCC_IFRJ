...
<body>
    ...
    <div id="container-2">
            <form action="./tcc2.php" method="POST" id="formulario-escolha">
                ...
                <div>
                    <input type="radio" name="opcao" id="criar" value="1"><label for="criar"> Criar Tcc</label><br><br>

                    <input type="radio" name="opcao" id="pesquisar" value="2"><label for="pesquisar"> Pesquisar Tcc</label><br><br>

                    <input type="radio" name="opcao" id="listar" value="3"><label for="listar"> Mostrar Tcc</label><br><br>

                    <input type="radio" name="opcao" id="alterar" value="4"><label for="alterar"> Alterar Tcc</label><br><br>

                    <input type="radio" name="opcao" id="excluir" value="5"><label for="excluir"> Excluir Tcc</label>
                </div><br>
