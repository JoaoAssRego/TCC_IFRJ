...
<body>
    ...
    <div id="container-2">
            <form action="./aluno2.php" method="POST" id="formulario-escolha">
                ...
                <div>
                    <input type="radio" name="opcao" id="inserir" value="1"><label for="inserir"> Inserir ALuno</label><br><br>

                    <input type="radio" name="opcao" id="pesquisar" value="2"><label for="pesquisar"> Pesquisar Aluno</label><br><br>

                    <input type="radio" name="opcao" id="mostrar" value="3"><label for="mostrar"> Mostrar Aluno</label><br><br>

                    <input type="radio" name="opcao" id="alterar" value="4"><label for="alterar"> Alterar Aluno</label><br><br>

                    <input type="radio" name="opcao" id="excluir" value="5"><label for="excluir"> Excluir Aluno</label>
                </div><br>
